...
if (!$data) {
    echo "<html><body><script src='https://cdn.jsdelivr.net/npm/sweetalert2@11'></script><script>Swal.fire({icon: 'error', title: 'Gagal', text: 'Data jadwal tidak ditemukan!'}).then(() => { window.location='jadwal.php'; });</script></body></html>";
    exit;
}
...
<head>
    <meta charset="UTF-8">
    <title>Edit Jadwal Admin - Cliniq</title>
...
<body class="py-5">
    <div class="container">
        <div class="card border-0 shadow-sm mx-auto p-4 p-md-5" style="max-width: 600px; border-radius: 24px;">
            <div class="d-flex align-items-center mb-4">
                <a href="jadwal.php" class="btn btn-light rounded-circle me-3"><i class="fas fa-chevron-left"></i></a>
                <div>
                    <h4 class="fw-bold mb-0" style="color: #0f3d2e;">Edit Jadwal Praktik</h4>
                    <p class="text-muted small mb-0">Perbarui dokter, jam operasional, atau batas kuota.</p>
                </div>
            </div>
